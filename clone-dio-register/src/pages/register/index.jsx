        ...
        <Column>
          <Wrapper>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <Input errorMessage={errors.name?.message} leftIcon={<MdPerson color={'#8647AD'} />} control={control} name="name" placeholder="Nome completo" />
              <Input errorMessage={errors.email?.message} leftIcon={<MdEmail color={'#8647AD'} />} control={control} name="email" placeholder="E-mail" />
              <Input errorMessage={errors.password?.message} leftIcon={<MdLock color={'#8647AD'} />} control={control} name="password" placeholder="Password" />
